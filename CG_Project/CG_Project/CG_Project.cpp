...
BEGIN_MESSAGE_MAP(CCG_ProjectApp, CWinApp)
...
// 僅有的一個 CCG_ProjectApp 物件

CCG_ProjectApp theApp;


// CCG_ProjectApp 初始設定

BOOL CCG_ProjectApp::InitInstance()
{
